 ...
 * admite una unica accion, «recheck», que no ejecuta nada por si misma: deja
 * una senal en disco para que systemd lance el colector como root.
 */
...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    if (!in_array($accion, ['recheck', 'ban', 'unban'], true)) {
